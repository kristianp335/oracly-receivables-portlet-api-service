...
/**
 * Provides the local service interface for Receivable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ReceivableLocalServiceUtil
...
public interface ReceivableLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ReceivableLocalServiceUtil} to access the receivable local service. Add custom service methods to {@link com.liferay.oracly.accounts.receivable.service.impl.ReceivableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Receivable createReceivable(long fooId);
	...
	*/
	...
	public Receivable deleteReceivable(Receivable receivable);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Receivable deleteReceivable(long fooId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Receivable fetchReceivable(long fooId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Receivable fetchReceivableByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Receivable getReceivable(long fooId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Receivable getReceivableByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Receivable> getReceivables(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Receivable> getReceivablesByUuidAndCompanyId(
